...
def getdistmat(coordinates):
    ...
    print(distmat)
    print('-'*100)
    # np.savetxt('test.txt', distmat, fmt='%d')
    return distmat


def ResultShow( BestPath, CityNum):
    print("求得的最优路径为：")
...
numant = 52  ##// 蚂蚁个数（蚂蚁个数最好大于等于城市个数，保证每个城市都有一个蚂蚁）
